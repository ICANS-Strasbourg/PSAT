...
class nnUNetTrainer_1000epochs_NoMirroring_contraction_07to25(nnUNetTrainer):
    def __init__(
        ...
        self.num_epochs = 1000 # nnUNet default is 1000

    # here we remove Mirroring from the training transforms
    ...
    def get_training_transforms(
        ...
        for transform in tr_transforms.transforms:
            if isinstance(transform, SpatialTransform):
                transform.scaling = (0.7, 2.5) # defaut is (0.7, 1.4), here we change it to (0.7, 2.5) to allow more contraction
